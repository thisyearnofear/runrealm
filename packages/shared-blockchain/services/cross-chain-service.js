...
export class CrossChainService extends BaseService {
    ...
    setupEventListeners() {
        ...
        this.subscribe("crosschain:territoryClaimRequested", async (data) => {
            await this.handleCrossChainTerritoryClaim(data);
        });
        // Listen for cross-chain stats updates
        this.subscribe("crosschain:statsUpdateRequested", async (data) => {
     ...
     */
    async handleIncomingCrossChainMessage(message) {
        try {
     ...
     */
    async handleCrossChainTerritoryClaim(data) {
        try {
     ...
     */
    async handleCrossChainStatsUpdate(data) {
        try {
     ...
     * Encode territory data for cross-chain transmission
     */
    encodeTerritoryData(territoryData) {
     ...
     */
    async sendCrossChainMessageEnhanced(params) {
        try {
