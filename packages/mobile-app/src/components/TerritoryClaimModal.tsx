...
export const TerritoryClaimModal: React.FC<TerritoryClaimModalProps> = React.memo(
  ({ visible, runData, territoryService, web3Adapter, onClose, onSuccess, onError }) => {
    ...
    // Calculate territory preview data from run session
    const territoryPreview = {
      name: 'Unnamed Territory',
      rarity: 'common' as const,
      difficulty: 50,
      estimatedReward: 10,
      distance: runData.totalDistance || 0,
      duration: runData.totalDuration || 0,
    };
              ...
              <>
                ...
                <ScrollView style={styles.content}>
                  ...
                  <View style={styles.infoCard}>
                    ...
                    <Text style={styles.difficultyText}>{territoryPreview.difficulty}/100</Text>
                  </View>
