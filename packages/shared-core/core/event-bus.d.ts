...
export interface Web3Events {
    ...
    "web3:transactionSubmitted": {
        hash: string;
        type: string;
    };
    "web3:transactionConfirmed": {
        hash: string;
        blockNumber: number;
    };
    "web3:transactionFailed": {
        hash?: string;
        error: string;
    };
    "web3:territoryClaimed": {
        tokenId: string;
        geohash: string;
        metadata: any;
    };
    ...
    "web3:crossChainTerritoryClaimFailed": {
        error: string;
        geohash: string;
    };
...
export interface AppEvents extends Web3Events {
    ...
    "mobile:gestureDetected": {
        type: string;
        data: any;
    };
    "territory:claimRequested": {
        runId: string;
    };
    ...
    "progression:achievementsLoaded": {
        count: number;
    };
    "progression:levelsLoaded": {
        maxLevel: number;
    };
    "run:startRequested": {};
    "location:changed": {
    ...
    "mobile:swipeLeft": {};
    "mobile:swipeRight": {};
    "mobile:orientationChanged": {
        orientation: string;
        compactMode?: boolean;
    };
    "mobile:compactModeChanged": {
        compactMode: boolean;
    };
    ...
    "staking:stakeStarted": {
        transactionHash: string;
        amount: number;
    };
    "staking:rewardEarned": {
        amount: number;
    };
    ...
    "crosschain:territoryClaimFailed": {
        error: string;
        data: any;
    };
    "crosschain:statsUpdateRequested": {
        statsData: any;
        targetChainId: number;
    };
    ...
    "fitness:tokens:updated": {
        source: string;
    };
    "fitness:tokens:cleared": {
        source: string;
    };
}
