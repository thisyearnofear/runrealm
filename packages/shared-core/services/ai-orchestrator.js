...
export class AIOrchestrator {
     ...
     */
    async requestRoute(params, options = {}) {
     ...
     */
    async requestGhostRunner(params, options = {}) {
    ...
    createRequestStatus(id, type, status, progress, error) {
        const requestStatus = {
            id,
            type,
            status,
    ...
    updateRequestStatus(id, status, progress, error) {
    ...
    async emitWithTimeout(event, data, timeout) {
    ...
    handleRequestError(requestId, type, errorMessage) {
