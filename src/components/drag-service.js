...
export class DragService extends BaseService {
    constructor() {
        ...
        this.dragStarted = false; // Track whether actual dragging has begun
        this.dragThreshold = 10; // Minimum pixels to move before starting drag
    }
    async onInitialize() {
     ...
     */
    getWidgetZoneForElement(element) {
