      ...
      `,
        ...
        if (data.waypoints && data.waypoints.length > 0) {
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              <div style="width: 20px; height: 20px; border-radius: 50%; background-color: ${wp.type === 'territory_claim' ? '#ff0000' :
                        wp.type === 'rest_stop' ? '#0000ff' :
                            wp.type === 'landmark' ? '#ffff00' :
                                wp.type === 'strategic' ? '#ff00ff' : '#00ffff'}; margin-right: 10px;"></div>
              <div>
