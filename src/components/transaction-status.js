...
export class TransactionStatus extends BaseService {
    constructor(domService, uiService, animationService, options = {}) {
        super();
    ...
    getTransactionDescription(type, metadata) {
    ...
    addTransactionStyles() {
        if (document.querySelector('#transaction-status-styles'))
            return;
