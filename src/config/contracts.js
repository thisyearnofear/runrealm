...
export function getCurrentNetworkConfig() {
    ...
    return {
        ...
        rpcUrl: globalThis.__ENV__?.ZETACHAIN_RPC_URL || 'https://zetachain-athens-evm.blockpi.network/v1/rpc/public',
        explorerUrl: 'https://zetachain-athens-3.blockscout.com',
        contracts: {
            universal: {
                address: globalThis.__ENV__?.TERRITORY_MANAGER_ADDRESS || '0x7A52d845Dc37aC5213a546a59A43148308A88983',
                abi: UNIVERSAL_CONTRACT_ABI
            },
            realmToken: {
                address: globalThis.__ENV__?.REALM_TOKEN_ADDRESS || '0x18082d110113B40A24A41dF10b4b249Ee461D3eb',
                abi: REALM_TOKEN_ABI
            }
        }
    };
