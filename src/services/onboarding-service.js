...
export class OnboardingService extends BaseService {
    ...
    async showStep(stepIndex) {
        if (!this.onboardingConfig || !this.overlay || !this.tooltip)
            return;
    ...
    setupEventListeners() {
        ...
        this.subscribe('onboarding:skip', () => {
            this.skip();
        });
    }
    /**
